                ...
                <div class="row">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active"><a href="shop.jsp">Profile page</a></li>
                        </ul>
                    </div>  
                </div>
            </div>
                                    ...
                                    <table cellspacing="0" class="shop_table cart">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="product-subtotal">Desired Quantity</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr class="cart_item">
                                                ...
                                                <c:forEach var="product" items="${sessionScope.data}">
                                                    ...
                                                    <td class="product-remove">
                                                        <input type="hidden" name="customer" value="${sessionScope.customer.getId()}" />

                                                        <a title="Remove this item" class="remove" href="DeleteProductCart?id=${product.product.getProductId()}">Delete</a> 
                                                    </td>

                                                    <c:forEach var="object" items="${requestScope.dataproduct}">

                                                        <c:if test="${product.product.getProductId() eq object.getProductId()}">


                                                            <td class="product-thumbnail">
                                                                <img src="GetImage?x=${product.product.getProductId()}" width="40px"/>
                                                                <input type="hidden" name="ids" value="${product.product.getProductId()}" />
                                                            </td>
                                                            <td class="product-name">
                                                                <c:out value="${object.getName()}" />
                                                                <input type="hidden" name="cache" value="${sessionScope.customer.getCash()}" />
                                                            </td>
                                                            <td><c:out value="${object.getDesc()}" /></td>

                                                            <td class="product-price">
                                                                <span class="amount"><c:out value="${object.getPrice()}" /></span> 
                                                                <input type="hidden" name="prices" value="${object.getPrice()}" />
                                                            </td>

                                                            <td><c:out value="${object.getQuantity()}" /></td>

                                                            <td class="product-quantity">
                                                                <div class="quantity buttons_added">
                                                                    <input type="number"  name="qunatity"size="4" class="input-text qty text" title="Qty" value="1" min="1" step="1" max="${object.getQuantity()}">
                                        ...
                                        <ul class="products">
                                            <li class="product">
                                                <a href="single-product.jsp">
                                                    ...
                                                    <span class="price"><span class="amount">\A320.00</span></span>
                                                </a>
                                        ...
                                        <table cellspacing="0">
                                            <tbody>
                                                <tr class="cart-subtotal">
                                                    <th>Cart Subtotal</th>
                                                    <td><span class="amount">\A315.00</span></td>
                                                </tr>
                                                ...
                                                <tr class="order-total">
                                                    <th>Order Total</th>
                                                    <td><strong><span class="amount">\A315.00</span></strong> </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
