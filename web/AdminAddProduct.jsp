                                    ...
                                    <div class="col-md-12">
                                        <div class="product-bit-title text-center" >
                                            ...
                                            <center>
                                                <div id="for" >
                                                    <div class="item" >
                                                        <form  style="background:#333945;width: 540px" enctype="multipart/form-data" class="well form-horizontal" action="AdminAddProduct" method="post"  id="contact_form">
                                                           
                                                                <!-- Form Name -->
                                                                <div style="color:#fff">New Product</div>
                                                                <!-- Text input-->
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        <label style="color:#fff" >serial Number</label>

                                                                        <input id="serialNumber"  type="text" name="serialNumber" placeholder="serial number" required/>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input id="fname"  name ="productname" type="text" placeholder="product name" required> 
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input id="price"  name ="productPrice" type="text" placeholder="product price" required> 
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input style="" id="quantity"  type="text" name="quantity"  placeholder="quantity "/>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                    ...
                                                                    <textarea style="color: #000" rows="4" cols="50" id="description" name="description" placeholder="write description"> </textarea>
                                                                    </div>     
