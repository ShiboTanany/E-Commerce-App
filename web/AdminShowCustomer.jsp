                    ...
                    <div class="collapse navbar-collapse" id="navbar" >
                        <ul class="nav pull-right navbar-nav" id="main_navigation_menu">
                           <li><a href="adminProfile.jsp">Profile</a></li>
                            ...
                            <li class="active"><a href="AdminShowCustomer">Show Customers</a></li>
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach var="user" items="${requestScope.data}">
                                            <tr>
                                                ...
                                                <td><c:out value="${user.getCash()}" /></td>
                                                <td><c:out value="${user.getBirthdate()}" /></td>
                                                <td><c:out value="${user.getJob()}"/></td>
                                                <td><c:out value="${user.getAddress()}" /></td>
                                                <td><c:out value="${user.getInterest()}" /></td>
                                                <td><img src="GetImageCustomer?x=${user.getId()}" width="100px"/></td>
                                            </tr>
                                        </c:forEach>
